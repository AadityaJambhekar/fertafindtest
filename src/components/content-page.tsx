    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-16">
        ...
        >
          ...
          <div className="mt-2 text-[1.05rem] leading-8 text-foreground">
            {answer}
          </div>
        </section>

        <div className="content-prose mt-10 text-[1.02rem] text-muted-foreground">
          {children}
        </div>
        ...
        <section className="mt-12 rounded-3xl border border-border bg-card p-5 sm:p-6">
          ...
          <p className="mt-2 leading-7 text-muted-foreground">
            This page helps you compare fertilizer prices on the same basis. It
            does not recommend application rates or products for your field.
            Rates and nutrient decisions depend on a soil test, your crop and
            growth stage, and local guidance from a qualified agronomist. See
            our{" "}
            <Link
              to="/terms"
        ...
        <div className="mt-12 border-t border-border pt-8">
          <p className="text-muted-foreground">
            {cta ?? (
              <>
                Have real quotes in hand? FertaFind puts them on one clear,
                cost-based footing.
              </>
            )}
          </p>

...
export type PriorFertilizerApplication = {
  applicationDate: string;
  productAnalysis: string;
  quantity: string;
  unit: "kg/ha" | "L/ha" | "lb/ac" | "gal/ac";
};
...
export type FarmContext = {
  ...
  growerNotes: string;
  priorFertilizerApplied?: boolean | null;
  priorFertilizerApplications?: PriorFertilizerApplication[];
};
...
export type QuoteAnalysis = {
  ...
  preferences: {
    ...
    organicCertification?: "certified" | "not_certified" | null;
  };
  fieldSize: number;
  unit: "ha" | "ac";

...
export type PageKey = "home" | "about" | "analyze" | "suppliers" | "terms";
...
export const PAGES: Record<PageKey, PageSeo> = {
  ...
  about: {
    path: "/about",
    title: "About FertaFind — How fertilizer quote comparison works",
    description:
      "Learn how FertaFind turns fertilizer quotes into consistent, comparable numbers and an AI-assisted, cost-based recommendation for your crop, field, and location.",
    ogTitle: "About FertaFind",
    ogDescription:
      "How FertaFind compares fertilizer quotes and produces an AI-assisted, cost-based recommendation.",
  },
  analyze: {
    path: "/analyze",
  ...
  suppliers: {
    path: "/suppliers",
    title: "Fertilizer suppliers on FertaFind",
    description:
      "Review fertilizer suppliers featured on FertaFind, including their crop programs and clearly labeled, supplier-reported field results.",
    ogTitle: "Fertilizer suppliers on FertaFind",
    ogDescription:
      "Explore suppliers and their crop programs, with clearly labeled supplier-reported field results.",
  },
  terms: {
    path: "/terms",

...
const CROP_STAGES: Record<string, string[]> = {
  Wheat: ["Establishment", "Tillering", "Stem elongation", "Booting / heading", "Grain filling", "Maturity"],
  "Corn / Maize": ["Pre-plant", "VE–V5", "V6–V7", "V8–VT", "R1–R3", "R4–R6"],
  Barley: ["Establishment", "Tillering", "Stem elongation", "Booting / heading", "Grain filling", "Maturity"],
  "Canola / Oilseed rape": ["Establishment", "Rosette", "Stem elongation", "Bud / flowering", "Pod filling", "Maturity"],
  Soybeans: ["Pre-plant", "VE–V5", "V6–Vn", "R1–R2", "R3–R4", "R5–R8"],
  Rice: ["Establishment", "Tillering", "Panicle initiation", "Heading / flowering", "Grain filling", "Maturity"],
  ...
  Potatoes: ["Planting / emergence", "Vegetative", "Tuber initiation", "Tuber bulking", "Maturation"],
  "Pasture / Forage": ["Establishment", "Active vegetative growth", "Pre-grazing / cutting", "Recovery", "Dormant"],
  ...
  const submit = useCallback(
    async (recaptchaToken: string) => {
      ...
      try {
        ...
        // Every analysis remains available in this browser. Existing supplier-account
        // sessions may also keep a private server-side copy without blocking public use.
        try {
                    ...
                    <div className="mt-2 grid grid-cols-3 gap-2">
                      {(
                        ...
                        <button
                          ...
                          onClick={() => setFertilizerOriginPreference(value)}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-sm text-muted-foreground">
                        Stage changes product fit and application-timing checks. Choose “Not sure” if needed.
                      </p>
                    </div>
                  </div>

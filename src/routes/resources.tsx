...
const GROUPS: Array<{
  ...
  },
  {
    ...
    heading: "Comparisons",
    blurb:
      "How common fertilizer products line up against each other on cost and handling.",
  },
  {
    section: "methodology",
    heading: "Methodology",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <p className="mt-4 max-w-2xl text-lg leading-8 text-muted-foreground">
          {RESOURCES.description} Everything here is about comparing prices
          fairly — not agronomic advice, and never a recommended rate.
        </p>

        {GROUPS.map((group) => {
          const pages = CONTENT_PAGES.filter(
            (p) => p.section === group.section,
          );
          return (
        ...
        <div className="mt-14 rounded-3xl border border-border bg-card p-6 sm:p-8">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            FertaFind does the conversions from these guides for you — grade,
            pack size and delivery — so your quotes land on one clear,
            cost-based footing.
          </p>
          <Link
            to="/analyze"

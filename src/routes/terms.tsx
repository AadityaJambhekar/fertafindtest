    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-10 space-y-9 text-[1.02rem] leading-8 text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-2xl font-semibold text-foreground">
              Accounts and uploaded information
            </h2>
            <p className="mt-2">
              You must provide accurate account and farm information and have permission to upload
              each file. Do not upload information you are not authorised to share. Supplier
              listings, prices, service areas, and product data must be truthful and current. By
              selecting the acceptance box during account creation, you agree to the version of
              these Terms shown at that time.
            </p>
          </section>
          <section>
            <h2 className="font-display text-2xl font-semibold text-foreground">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              review, change, suspend, or remove accounts, listings, recommendations, or features
